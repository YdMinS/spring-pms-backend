 ...
 * {@code acct.thumbnailTemplate/detailTemplate}(LAZY) 를 접근한다. 호출부(썸네일=
 ...
 * DetailTemplate d = channelTemplateResolver.resolveDetail(cell);
 * </pre>
 *
...
public class ChannelTemplateResolver {
    ...
    /** Account's detail template if assigned, else the tenant default (throws if neither exists). */
