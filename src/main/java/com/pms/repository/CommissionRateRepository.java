...
public interface CommissionRateRepository extends JpaRepository<CommissionRate, Long> {
    Optional<CommissionRate> findByPlatformAndCategory(Platform platform, Category category);
    ...
    Optional<CommissionRate> findByPlatformAndCategoryId(@Param("platform") Platform platform,
                                                         @Param("categoryId") Long categoryId);

    @Query("SELECT cr FROM CommissionRate cr LEFT JOIN FETCH cr.category")
    List<CommissionRate> findAll();

    List<CommissionRate> findByPlatform(Platform platform);
}
