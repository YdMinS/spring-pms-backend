...
public class UserController {
    ...
    public ResponseEntity<ResponseDTO<UserResponse>> updateUser(
        ...
        return ResponseEntity.ok(ResponseDTO.success("User updated successfully", response));
    }
    ...
    public ResponseEntity<ResponseDTO<UserResponse>> updateRole(
        ...
        return ResponseEntity.ok(ResponseDTO.success("User role updated successfully", response));
    }
}
