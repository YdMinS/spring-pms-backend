...
public class ProductTestFixture {
    ...
    public static UpdateProductRequest createUpdateRequest() {
        return UpdateProductRequest.builder()
                ...
                .netContentUnit(java.util.Optional.of("G"))
                .packageHeight(java.util.Optional.of("147.8mm"))
                .packageLength(java.util.Optional.of("71.8mm"))
                .packageWidth(java.util.Optional.of("7.80mm"))
                .netContent(java.util.Optional.of("171g"))
    ...
    public static Product createSmartphoneProduct(Long id) {
        Product product = Product.builder()
                ...
                .store("Apple Store")
                .netContentUnit("G")
                .packageHeight("147.8mm")
                .packageLength("71.8mm")
                .packageWidth("7.80mm")
                .netContent("171g")
